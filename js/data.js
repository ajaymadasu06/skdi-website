...
var products = [
  ...
  /* ── CEMENT ──
     Only 50kg bags for now. Brand names to be updated later from Admin. */
  { id: 9,  name: 'Cement 50kg — Brand 1', cat: 'Cement', price: 12,  unit: 'bag', desc: 'Cement bag, 50kg. Update the name here once the brand is confirmed.', featured: true  },
  { id: 10, name: 'Cement 50kg — Brand 2', cat: 'Cement', price: 11,  unit: 'bag', desc: 'Cement bag, 50kg. Update the name here once the brand is confirmed.', featured: true  },
...
var orders = JSON.parse(localStorage.getItem('skdi_orders') || JSON.stringify([
  { id: 'ORD-001', customer: 'Ravi Kumar',  items: 'TMT 12mm x10, Cement 50kg x20',  total: 'Rs.720',  status: 'delivered',  date: '2025-01-10' },
  { id: 'ORD-002', customer: 'Sita Reddy', items: 'TMT 16mm x5, GI Roofing Sheet x6', total: 'Rs.3240', status: 'processing', date: '2025-01-15' },
  { id: 'ORD-003', customer: 'Mahesh B.',  items: 'Cement 50kg x30, Cement Roofing Sheet x4', total: 'Rs.1850', status: 'pending',    date: '2025-01-18' }
]));
